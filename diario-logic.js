...
(function () {
  ...
  // depois reconcilia com o progresso salvo dela e liga a escuta em tempo
  // real. O documento de cada visitante vive em progress/<uid anônimo> —
  // ninguém mais lê ou escreve nele, e o Firestore garante isso pelas
  ...
  if (window.firebase && window.DIARIO_FIREBASE_CONFIG) {
    ...
    firebase.auth().onAuthStateChanged(function (user) {
      if (!user || viewerId) return; // já tratado (ou ainda sem sessão)
      viewerId = user.uid;
